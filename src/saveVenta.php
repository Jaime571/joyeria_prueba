...
if (isset($_POST['id_cliente'], $_POST['id_producto'], $_POST['cantidad'], $_POST['tipo_pago'])) {
    ...
    $sql1 = "INSERT INTO venta (id, fecha, tipo_pago, cliente_id)
             VALUES (?, ?, ?, ?)";

    // Consulta SQL para factura_clientes
    $sql2 = "INSERT INTO factura_clientes (id, producto_id, venta_id, cantidad)
             VALUES (?, ?, ?, ?)";
